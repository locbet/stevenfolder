   ...
   public class TagSelect:_Tag
    {
        ...
        /// <param name="html"></param>
        /// <returns></returns>
        public static string InnerHtml(string name, string html)
        {
        ...
        public static Dictionary<string, string> SelectOptions(string name, string html)
        {
            string pattern_name = string.Format("<SELECT([^<>]*)name\\s*=\\s*[\"']?{0}[\"'\\s]+([^<>]*)>(.*?)</SELECT>", name);
            Match m = Regex.Match(html, pattern_name, CurrentRegexOptions);
        ...
        /// <param name="html"></param>
        /// <returns></returns>
        public static string SelectedValue(string name, string html)
        {
